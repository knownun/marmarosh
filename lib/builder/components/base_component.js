...
var Base = function () {
  ...
  _createClass(Base, [{
    ...
    value: function saveConfig(configPath, overrideObj) {
      var data = Base.readConfig(configPath, overrideObj);
    ...
    value: function initTemplateLocals() {
      ...
      var helpers = this[local.templateLocals] = new Helpers(config);
      var addWidget = this.addWidgetToConfig;
    ...
    value: function addWidgetToConfig(name, typeName) {
