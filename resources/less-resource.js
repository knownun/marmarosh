...
var LessResource = function (_BaseResource) {
  _inherits(LessResource, _BaseResource);

  function LessResource() {
    _classCallCheck(this, LessResource);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(LessResource).apply(this, arguments));
  }

  _createClass(LessResource, [{
    key: "getSrc",
    value: function getSrc() {
      ...
      try {
        for (var _iterator = resourceSrc[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          var collected = LessResource.collectScripts(src, path);
    ...
    value: function getUrl() {
      var url = _get(Object.getPrototypeOf(LessResource.prototype), "getUrl", this).call(this);
      ...
      if (split) {
        ...
        try {
          for (var _iterator2 = Object.keys(split)[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
            ...
            output.push((0, _url.resolve)("/", target, name + ".css"));
          }
        } catch (err) {
    ...
    value: function collectScripts(src, paths) {
      ...
      try {
        for (var _iterator3 = paths[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          ...
          var modulePath = (0, _helpers.join)(src, path);
          var collected = (0, _glob.sync)(modulePath, { nosort: false });
          if (collected.length) {
